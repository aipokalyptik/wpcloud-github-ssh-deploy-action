...
assert_contains ".git/" "$default_exclude_tmp/rsync-excludes"
assert_contains ".gitignore" "$default_exclude_tmp/rsync-excludes"
assert_contains ".gitattributes" "$default_exclude_tmp/rsync-excludes"
assert_contains ".gitmodules" "$default_exclude_tmp/rsync-excludes"
...
if command -v rsync >/dev/null 2>&1; then
  ...
  [[ ! -e "$rsync_dest/.gitignore" ]] || fail "default excludes should omit .gitignore"
  [[ ! -e "$rsync_dest/.gitattributes" ]] || fail "default excludes should omit .gitattributes"
  [[ ! -e "$rsync_dest/.gitmodules" ]] || fail "default excludes should omit .gitmodules"
